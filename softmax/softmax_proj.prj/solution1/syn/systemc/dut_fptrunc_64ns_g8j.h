...
// ==============================================================
#ifndef __dut_fptrunc_64ns_g8j__HH__
#define __dut_fptrunc_64ns_g8j__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(dut_fptrunc_64ns_g8j) {
    ...
    SC_CTOR(dut_fptrunc_64ns_g8j):  ACMP_fptrunc_U ("ACMP_fptrunc_U") {
