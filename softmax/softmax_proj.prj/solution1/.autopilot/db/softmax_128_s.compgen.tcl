...
set ID 17
set hasByteEnable 0
set MemName softmax_128_s_eulbkb
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { output_layer_address0 { O 7 vector } output_layer_ce0 { O 1 bit } output_layer_q0 { I 32 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    id 19 \
    name probability_distribu \
    reset_level 1 \
    sync_rst true \
    dir O \
    corename probability_distribu \
    op interface \
    ports { probability_distribu_address0 { O 7 vector } probability_distribu_ce0 { O 1 bit } probability_distribu_we0 { O 1 bit } probability_distribu_d0 { O 32 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'probability_distribu'"
}
}
