...
set rc [catch {
  ...
  add_files -quiet /home/xl834/transformer/ECE6775FinalProjectTB/GEMM/zedboard_project/xillybus/vivado/xillydemo.runs/synth_1/xillydemo.dcp
...
set rc [catch {
  ...
  route_design 
  set src_rc [catch { 
    puts "source /home/xl834/transformer/ECE6775FinalProjectTB/GEMM/zedboard_project/vivado-essentials/showstopper.tcl"
    source /home/xl834/transformer/ECE6775FinalProjectTB/GEMM/zedboard_project/vivado-essentials/showstopper.tcl
  } _RESULT] 
  if {$src_rc} { 
    send_msg_id runtcl-1 error "$_RESULT"
    send_msg_id runtcl-2 error "sourcing script /home/xl834/transformer/ECE6775FinalProjectTB/GEMM/zedboard_project/vivado-essentials/showstopper.tcl failed"
    return -code error
  }
